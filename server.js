...
app.use(cors({ credentials: true ,origin:'https://frontend-flipkart-3rca.vercel.app'}))
//app uses
...
app.use((req, res, next) => {
    res.header('Access-Control-Allow-Origin', 'https://frontend-flipkart-3rca.vercel.app');
